...
AGENTS_PROVIDER_SOURCE_PATH = "template_rpa/kagents.yaml"
AGENTS_TOOLS_SOURCE_PATH = "template_rpa/tools.yaml"
AGENTS_AGENT_SOURCE_PATH = "template_rpa/agent.py"
...
class RpaPluginGen:
    ...
    def generate_provider_yaml_files(self, agent_infos):
